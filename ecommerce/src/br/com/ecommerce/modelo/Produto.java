 ...
 * 3) Toda Classe JavaBeans deve possuir no mínimo 2 CONSTRUTORES: 
 *    - vazio 
 *    - outro com todos os atributos de parâmetros (cheio)
 * 
 */
...
public class Produto {
	...
	//CONSTRUTOR CHEIO
	public Produto(int id, String descricao, float valorCompra, float valorVenda, int qtde) {
	...
	//Source > Generate Getters e Setters... > Select All
